...
vim.keymap.set(
    ...
    "<leader>.",
    [[<C-W>>]],
    { silent = true, desc = "Expand buffer window horizontally right", noremap = true }
)
vim.keymap.set(
    "n",
    "<leader>,",
    [[<C-W><]],
    { silent = true, desc = "Shrink buffer window horizontally left", noremap = true }
)
vim.keymap.set(
    "n",
    "<leader>-",
    [[<C-W>-]],
    { silent = true, desc = "Shrink buffer window vertically up", noremap = true }
)
vim.keymap.set(
    "n",
    "<leader>=",
    [[<C-W>+]],
    { silent = true, desc = "Expand buffer window vertically down", noremap = true }
)
...
vim.keymap.set(
    ...
    "<leader>r",
    vim.cmd.CopyRelPath,
    { silent = true, desc = "Copy current buffer relative path", noremap = true }
)
